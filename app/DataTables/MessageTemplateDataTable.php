...
class MessageTemplateDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                $editUrl = route('mesaage_templates.edit', $row->id);
                $deleteUrl = route('mesaage_templates.destroy', $row->id);
    ...
    {
        return $this->builder()
                    ->setTableId('messagetemplate-table')
    ...
    {
        return 'MessageTemplate_' . date('YmdHis');
    }
}
